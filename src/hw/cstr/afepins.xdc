...
set_property IOSTANDARD LVCMOS18 [get_ports {adc_spi_cs adc_spi_sck adc_spi_sdi adc_spi_sdo}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {eeprom_csn eeprom_sck eeprom_sdi eeprom_holdn eeprom_sdo}]
